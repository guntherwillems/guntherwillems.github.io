  ...
  for ( i=0; i<=CGallery.lastImageN; ++i)
   {
    if (typeof(CGallery.data[i].thumb) != 'undefined')
      thumbsS += "<a href=\"javascript:CGallery.ChangeImage(" + i + ")\"><img title=\"image " + (i + 1)  + "\" src=\"" + CGallery.data[i].thumb + "\" id=\"CGimg\" /></a>";
	else if ( CGallery.useImagesAsThumbs == true )
	  thumbsS += "<a href=\"javascript:CGallery.ChangeImage(" + i + ")\"><img title=\"image " + (i + 1) + "\" src=\"" + CGallery.data[i].image + "\" id=\"CGimg\" width=\"" + CGallery.thumbSize + "\" /></a>";
   }
...
FullScreen : function()
 {
  ...
  CGallery.canvas.style.width = "99.3%";
  CGallery.canvas.style.height = "99.3%";
